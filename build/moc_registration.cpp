...
QT_MOC_LITERAL(1, 13, 14), // "regFrameSignal"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "registration\0regFrameSignal\0"
};
...
void registration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->regFrameSignal(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&registration::regFrameSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void registration::regFrameSignal()
{
