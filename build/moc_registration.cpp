...
QT_MOC_LITERAL(1, 13, 27), // "registrationFrameDoneSignal"
QT_MOC_LITERAL(2, 41, 0) // ""

    },
    "registration\0registrationFrameDoneSignal\0"
    ""
};
...
void registration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->registrationFrameDoneSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (registration::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&registration::registrationFrameDoneSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject registration::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_registration.data,
...
// SIGNAL 0
void registration::registrationFrameDoneSignal(int _t1)
{
